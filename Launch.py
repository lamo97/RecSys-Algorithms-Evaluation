...
def predict(recommender):
    ...
    sys_result.to_csv('sys_results.csv')
    users_result.to_csv('user_results.csv')
...
representations =  [
    ...
    'Word2Vec', 'Doc2Vec',
    'GensimLDA','GensimRandomIndexing',
    'Word2Doc-GloVe','Sentence2Doc-Sbert', 'WordEmbedding','FastText']
...
ca_config.add_multiple_config(
    ...
    [
        ...
        # GensimLDA 
        ca.FieldConfig(
            ca.WordEmbeddingTechnique(ca.GensimLDA()),
            ca.NLTK(stopwords_removal=True, lemmatization=True),
            id='GensimLDA'
        ),
        ...
        #ca.FieldConfig(
        #    ca.WordEmbeddingTechnique(ca.GensimRandomIndexing()),
        #    ca.NLTK(stopwords_removal=True, lemmatization=True),
...
while(True):
    ...
    if(alg_choice == 1):
        ...
        predict(centroid_vector)

    elif(alg_choice == 2):
        logistic_regression = rs.ClassifierRecommender({fields[0]: [representations[choice-1]]}, rs.SkLogisticRegression())
